-----------------------------------------------------------------------------
-- This file contains all lsp setup 
-----------------------------------------------------------------------------
...
-----------------------------------------------------------------------------
-- nvim-lsp-installer 
-- In order for nvim-lsp-installer to register the necessary hooks at the right moment, make sure you call the require("nvim-lsp-installer").setup() function before you set up any servers (before nvim-lspconfig!)
-----------------------------------------------------------------------------
